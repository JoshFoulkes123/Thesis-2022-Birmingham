...
#representation
representation = np.array([0.3,50,300,1,-250,200,1,40,0,45,90,135,180,225,270,315,200,100,100,200,100,200,200,100,200,100,100,200,100,200,200,100,80])
...
min_max = np.array([[0,2],[0,1000],[0,360],[0,180],[-250,-250],[0,1000],[0,10],[0,360],[0,360],[0,360],[0,360],[0,360],[0,360],[0,360],[0,360],[0,360],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0],[1000,0]])
...
def fitness_solo(agent):
    ...
    while robot.step(timestep) != -1: 
        ...
        if robot.getTime() > fitness_time:
            out = 1000*(node.getPosition()[1]+8)-(node.getPosition()[0]*10)**2
            robot.simulationReset()
            break
        for i in range(8):
            if turn== 0 :
